...
> Please checkout [xxx](xxx) instead.
...
curl -s @TODO -o ./.github/workflows/screen.yaml
```
...
```sh
mkdir -p ./.github/workflows
curl -s @TODO -o ./.github/workflows/update-screen.yaml
```
...
So please use [GithubActions: taking fresh screens](GithubActions:_taking_fresh_screens.) to take fresh screen captures instead of execution in local.
